                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                ...
                                if(form_error() || validation_errors()){
                                    ...
                                    ?>
                                    <div class="card-header"><h3 class="text-center font-weight-light my-0">Registrasi Akun Peminjaman Ruang</h3></div>
                                    <div class="card-body">
                                        <form class="user_barang" method="post" action="<?php echo base_url('regis/aksi_regis');?>">
