    ...
    <div class="card mb-3">
          ...
          <div class="card-body">
            <div class="table-responsive">
               <?php foreach($opd as $kk){ ?>
              <form method="post" action="<?php echo base_url().'adminbarang/opd_edit_aksi'; ?>">
                  <div class="form-group">
                    <label class="control-label col-md-3">OPD<sup style="color:red">*</sup></label>
                       <div class="col-md-9">
                            <input type="hidden" value="<?php echo $kk->id_opd; ?>" name="id_opd">
                            <input type="text" class="form-control" placeholder="" name="nama_opd" value="<?php echo $kk->nama_opd; ?>" onkeypress="return event.charCode < 48 || event.charCode  >57">
                        </div>
                  </div>
                  <div class="form-group">
                       <div class="col-md-9">
                            <input type="submit" class="btn btn-success " value="Simpan">
                            <a href="<?php echo base_url().'adminbarang/opd'; ?>" class="btn btn-danger" value="Batal">Batal</a>
