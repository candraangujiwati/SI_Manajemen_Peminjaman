         ...
         <tbody>
          ...
          foreach($opd as $kk){
            ...
            <tr>
              ...
              <td>
                <a  href="<?php echo base_url().'adminbarang/opd_edit/'.$kk->id_opd; ?>"
                <i class="fa fa-edit"></i></a> &nbsp;
                <a  href="<?php echo base_url().'adminbarang/opd_delete/'.$kk->id_opd;?>" onclick="return confirm('Yakin Ingin Menghapus Data Ini?')"> <i class="fa fa-times"></i></a>
              </td>
