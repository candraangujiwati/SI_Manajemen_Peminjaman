    ...
    <div class="card mb-3">
          ...
          <div class="card-body">
              <?php if(validation_errors()) { ?>
                ...
                ?>
                <?php echo form_open_multipart('adminbarang/new_pinjam_barang_out_simpan/','class="form-horizontal"'); ?>
                      <div class="form-body">
                       ...
                       <!--<input type="hidden" name="judul_notif_barang" value="<?php e//cho $judul_notif_barang;?>">-->
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                            <div class="form-group">
                            <label class="control-label col-md-10">Tanggal Pengembalian<sup style="color:red">*</sup></label>
                              <div class="col-md-9">
