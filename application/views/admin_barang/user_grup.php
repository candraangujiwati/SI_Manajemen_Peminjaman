  ...
  <div id="content-wrapper">
    ...
    <div class="card mb-3">
          <div class="card-header">
            ...
            Data User Grup / Role User</div>

          <div class="card-body">
            <div class="table-responsive">
<!--<a class="btn btn-success " href="user_grup_tambah">Tambah <i class="fa fa-plus"></i></a><br>-->
         ...
         <tbody>
          <?php 
          $no = 1;
          foreach($user_grup as $ug){
            ?>
            <tr>
              <td><?php echo $no++; ?></td>
              <td><?php echo $ug->nama_user_grup; ?></td>
              <td>
                <a  href="<?php echo base_url().'adminbarang/user_grup_edit/'.$ug->id_user_grup; ?>"
                <i class="fa fa-edit"></i></a> &nbsp;
               <!-- <a  href="<?php //echo base_url().'admin/user_grup_delete/'.$ug->id_user_grup;?>" onclick="return confirm('Yakin Ingin Menghapus Data ?')"> <i class="fa fa-times"></i></a>-->
              </td>
