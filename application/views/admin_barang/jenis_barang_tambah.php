  ...
  <div id="content-wrapper">
    ...
    <div class="card mb-3">
          <div class="card-header">
            ...
            Tambah Jenis Barang</div>

          <div class="card-body">
            <div class="table-responsive">
              <form method="post" action="<?php echo base_url().'adminbarang/jenis_barang_tambah_aksi'; ?>">
                  <div class="form-group">
                    <label class="control-label col-md-3">Jenis Barang<sup style="color:red">*</sup></label>
                       <div class="col-md-9">
                            <input type="text" class="form-control" placeholder="" name="jenis_barang" onkeypress="return event.charCode < 48 || event.charCode  >57">
                        </div>
                  </div>
                  <div class="form-group">
                       <div class="col-md-9">
