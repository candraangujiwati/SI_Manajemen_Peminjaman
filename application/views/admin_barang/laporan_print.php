...
<link rel="icon" type="image/png" sizes="32x32" href="https://surakarta.go.id/wp-content/uploads/2017/04/cropped-Logo-Pemkot-square.png">
    ...
    <div class="card mb-3" id="cardbayar">
            ...
            <th>E-mail Aktif</th> 
                        ...
                        echo "<tr>";   
                        echo "<td style='width: 1px;'>".$data->id_pinjam_barang."</td>";                 
                        echo "<td style='width: 7px;'>".$tgl_pinjam_barang."</td>";                
                        echo "<td style='width: 7px;'>".$data->tgl_kembali_barang."</td>";                
                        echo "<td style='width: 20px;'>".$data->nama_barang."</td>";                
                        echo "<td style='width: 1px;'>".$data->jumlah_pinjam."</td>";                
                        echo "<td style='width: 5px;'>".$data->keperluan."</td>"; 
                        echo "<td style='width: 5px;'>".$data->nip."</td>";
                        echo "<td style='width: 7px;'>".$data->nama."</td>";
                        echo "<td style='width: 7px;'>".$data->no_hp_peminjam_barang."</td>";                           
                        echo "<td style='width: 7px;'>".$data->email_peminjam_barang."</td>";    
