    ...
    <div class="card mb-3">
          ...
          <div class="card-body">
               <?php if(validation_errors()) { ?>
                ...
                ?>
                      <?php echo form_open_multipart('adminbarang/new_pinjam_barang_in/'.$id_pinjam_barang.''); ?>
                      <div class="form-body">
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="row">
                              ...
                              <a href="<?php echo base_url().'adminbarang/new_pinjam_barang/'; ?>" class="btn btn-primary" value="Batal">Batal</a>
                               
                                <button type="submit" class="btn btn-success">Setujui</button>
                                <a  class="btn btn-danger" href="<?php echo base_url().'adminbarang/pinjam_barang_delete/'.$id_pinjam_barang?>" onclick="return confirm('Yakin Ingin Menolak Pengajuan Ini?')">Tolak</a> 
                                  </div>
                            </div>
                          </div>
                          <div class="col-md-6">
