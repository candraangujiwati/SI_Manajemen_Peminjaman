    ...
    <div class="card mb-3">
          ...
          <div class="card-body">
               <?php if(validation_errors()) { ?>
                ...
                ?>
                      <?php echo form_open_multipart('penggunabarang/new_pinjam_barang_perpanjang_simpan/','class="form-horizontal"'); ?>
                      <div class="form-body">
              ...
              <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <div class="col-md-9">
                                <input type="file" class="form-control" name="surat_pinjam_barang" required>
                              </div>
                            </div>
                        </div>
                      </div>
