  ...
  <div id="content-wrapper">
    ...
    <div class="card mb-3">
          ...
          <h6>Barang Tidak Bisa Diperpanjang Pinjam, Dikarenakan Barang Tidak Tersedia.</h6>
           ...
           <a class="btn btn-success " href="new_pinjam_barang_tambah">Tambah <i class="fa fa-plus"></i></a>
            ...
            <?php if ($this->session->userdata('nama') == $r->nama) { ?>
              ...
              <td>
                <?php
                        ...
                        <a  class="btn btn-info" href="<?php echo base_url().'penggunabarang/new_pinjam_barang_detail/'.$r->id_pinjam_barang?>">Detail</a> 
                        <a  class="btn btn-danger" href="<?php echo base_url().'penggunabarang/pinjam_barang_delete/'.$r->id_pinjam_barang?>" onclick="return confirm('Yakin Ingin Membatalkan Pengajuan Ini?')">Batal Pinjam</a> 
                       <?php
                        }
                       
                        if ($r->status_pinjam_barang == 1 && $r->tgl_kembali_barang < date('Y-m-d') && $r->jumlah <= $r->jumlah_pinjam) { ?>
                            <span class="badge badge-success">Disetujui</span>
                            <a  class="btn btn-secondary" href="<?php echo base_url().'penggunabarang/new_pinjam_barang_out/'.$r->id_pinjam_barang?>/2">Kembalikan Barang</a> 
                           ...
                           <span  class="badge badge-warning">Barang Tidak Bisa Diperpanjang Pinjam</span>
                            <?php }
                               ...
                               <a  class="btn btn-secondary" href="<?php echo base_url().'penggunabarang/new_pinjam_barang_out/'.$r->id_pinjam_barang?>/2">Kembalikan Barang</a> 
                               <a  class="btn btn-success" href="<?php echo base_url().'penggunabarang/new_pinjam_barang_perpanjang/'.$r->id_pinjam_barang?>">Perpanjang Pinjam</a>
                             <?php } 
