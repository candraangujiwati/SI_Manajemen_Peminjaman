  ...
  <div id="content-wrapper">
    ...
    <div class="card mb-3">
          <div class="card-header">
           ...
           Edit Akun Pengguna Barang</div>

          <div class="card-body">
            <div class="table-responsive">
            <?php foreach($user as $u){ ?>
              <form method="post" action="<?php echo base_url().'penggunabarang/user_edit_aksi'; ?>">
              <div class="form-group">
                  ...
                  <div class="form-group">
                       <div class="col-md-9">
                            ...
                            <a href="<?php echo base_url().'penggunabarang/user'; ?>" class="btn btn-danger" value="Batal">Batal</a>
