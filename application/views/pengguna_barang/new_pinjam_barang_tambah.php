          ...
          <div class="card-header bg-">
            ...
            <div class="card-body">
                ...
                ?>
                      ...
                      <?php echo form_open_multipart('penggunabarang/new_pinjam_barang_simpan/','class="form-horizontal"'); ?>
                      <div class="form-body">
                     <h3 class="form-section"></h3>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                              <label class="control-label col-md-6">Surat Permohonan Pinjam (File .pdf ukuran max 500 Kb)</label>
                              <div class="col-md-9">
