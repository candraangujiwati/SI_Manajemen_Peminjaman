...
<div id="wrapper">
  ...
  <div id="content-wrapper">
    ...
    <div class="card mb-3">
        ...
        foreach($user as $u){
            ?>
           <ul>     <i class="fas fa-user fa-7x" style="margin-bottom: 20px; margin-top: 20px"></i>
          ...
          ?>
         <a href="<?php echo base_url().'penggunabarang/user'; ?>" class="btn btn-primary" value="Kembali">Kembali</a>
               <br>
