               ...
               <?php if(validation_errors()) { ?>
                ...
                ?>
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                              <label class="control-label col-md-9">Keperluan</label>
                              <div class="col-md-9">
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="row">
                              ...
                              <a href="<?php echo base_url().'penggunabarang/new_pinjam_barang_out/'; ?>" class="btn btn-success" value="Kembalikan Barang">Kembalikan Barang</a>
                                </div>
                            </div>
                          </div>
                          <div class="col-md-6">
