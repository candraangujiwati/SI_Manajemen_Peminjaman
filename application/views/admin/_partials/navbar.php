<nav class="navbar navbar-expand navbar-dark bg-success static-top">
    ...
    <?php echo "SISTEM PEMINJAMAN RUANG" ?></a>
    ...
    <?php 
        ...
        $notif = $this->db->from('notif')->where(['is_read' => 0])->order_by('id', 'DESC')->get()->result_array();
    ...
    ?>
        ...
        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true"
            ...
            <a class="dropdown-item" href="<?php echo base_url('admin/notif')?>"><?php echo $data['judul'] ?></a>  
            <?php endforeach; ?>
