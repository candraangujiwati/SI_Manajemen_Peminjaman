            ...
            <div class="table-responsive">
              <form method="post" action="<?php echo base_url().'admin/user_tambah_aksi'; ?>">
                  ...
                  <div class="form-group">
                      <label class="col-lg-12">User Grup</label>
                      <div class="col-md-9">
                  ...
                  <div class="form-group">
                    <label class="col-lg-12">Nama Lengkap</label>
                       <div class="col-md-9">
                            <input type="text" class="form-control" placeholder="Masukkan Nama Lengkap" name="name" onkeypress="return event.charCode < 48 || event.charCode  >57"> 
                        </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                       <div class="col-md-9">
                            ...
                            <a href="<?php echo base_url().'admin/user'; ?>" class="btn btn-danger" value="Batal">Batal</a>
