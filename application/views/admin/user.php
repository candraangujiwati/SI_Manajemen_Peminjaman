          ...
          foreach($user as $u){
            ...
            <tr>
              ...
              <?php if($this->session->userdata('nama') == $u->nama) { ?>
                <a  href="<?php echo base_url().'admin/user_profil/'.$u->id_user; ?>"<i class="fa fa-address-card"></i></a> &nbsp;
                <?php } ?>
                <a  href="<?php echo base_url().'admin/user_edit/'.$u->id_user; ?>"<i class="fa fa-edit"></i></a> &nbsp;
                <a  href="<?php echo base_url().'admin/user_delete/'.$u->id_user;?>" onclick="return confirm('Yakin Ingin Menghapus Data ?')"> <i class="fa fa-times"></i></a>
              </td>
