    ...
    <div class="card mb-3">
          ...
          <div class="card-body">
            <div class="table-responsive">
              <form method="post" action="<?php echo base_url().'admin/sesi_tambah_aksi'; ?>">
                  <div class="form-group">
                    <label class="control-label col-md-3">Waktu Sesi<sup style="color:red">*</sup></label>
                       <div class="col-md-9">
                       <!--<div class="input-group time form_time col-md-12"  data-time-format="hh:ii">
                                <span class="input-group-addon"><span class="fa fa-clock"></span></span>-->
                                 <input type="text" class="timepicker" name="waktu_sesi[]"> -
                                 <input type="text" class="timepicker" name="waktu_sesi[]">
